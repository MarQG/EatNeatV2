                                ...
                                <ul className="list-group">
                                    {this.props.search.filters[0].allergies.length > 0 ? 
                                        this.props.search.filters[0].allergies.map(allergy => (
                                            <li key={allergy} className="list-group-item"><i className="fa fa-plus-circle" aria-hidden="true"></i> {allergy}</li>
                                        )) 
                                    : <li>No Filters</li>
                                    }
                                </ul>
                                ...
                                <ul className="list-group">
                                    {this.props.search.filters[0].diet.length > 0 ? 
                                        this.props.search.filters[0].diet.map(diet => (
                                            <li key={diet} className="list-group-item"><i className="fa fa-plus-circle" aria-hidden="true"></i> {diet}</li>
                                        )) 
                                    : <li>No Filters</li>
                                    }
                                </ul>
